...
public class loggerfallas {
	...
	static FileWriter archivo ;
	  public static void crearLog(String Operacion) throws IOException {
	        ...
	        if (new File("M:\\Test Software Utilities\\log\\logfallas\\"+fecha+".txt").exists()==false){
	        	archivo=new FileWriter(new File("M:\\\\Test Software Utilities\\log\\logfallas\\"+fecha+".txt"),false);
	        	}
	             archivo = new FileWriter(new File("M:\\\\Test Software Utilities\\log\\logfallas\\"+fecha+".txt"), true);
